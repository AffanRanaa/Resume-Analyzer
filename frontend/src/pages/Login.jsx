        ...
        <div>
          <div className="bg-white/10 rounded-2xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-white font-medium text-sm">Affan Rana</p>
                <p className="text-indigo-200 text-xs">Software Engineer</p>
              </div>
            </div>
            <p className="text-white/80 text-sm leading-relaxed">"ResumeAI helped me identify missing keywords and boost my ATS score from 52 to 89. Got 3 interview calls the next week!"</p>
          </div>
          <h2 className="text-3xl font-bold text-white mb-3">Get your resume noticed by recruiters</h2>
          <p className="text-indigo-200">AI-powered analysis that tells you exactly what to fix.</p>
        </div>
        <p className="text-indigo-300 text-sm">© 2026 ResumeAI</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-5 text-center text-sm text-slate-500">
            ...
            <Link to="/register" className="text-indigo-600 hover:underline font-medium">Create one free</Link>
          </p>
        </div>
      </div>
    </div>
